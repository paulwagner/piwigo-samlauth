...
$lang['Username and mail address is mandatory. First and last name can be left empty if not available in your IPD configuration.'] = 'Benutzername und Mailadresse ist verpflichtend. Vor- und Nachname kann auch leer gelassen werden, wenn der verwendete IPD dies nicht unterst&uuml;tzt.';
